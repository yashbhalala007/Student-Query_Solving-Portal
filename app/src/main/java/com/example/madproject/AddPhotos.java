...
public class AddPhotos extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(id == android.R.id.home){
            Intent intent = new Intent(AddPhotos.this, DashboardActivity.class);
        ...
        filePath.putFile(ImageUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
            ...
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(AddPhotos.this,"Error Occured1: " + msg, Toast.LENGTH_LONG).show();
                }
            }
        });
    }
                            ...
                            .addOnCompleteListener(new OnCompleteListener() {
                                ...
                                public void onComplete(@NonNull Task task) {
                                    if(task.isSuccessful()){
                                        ...
                                        String msg = task.getException().getMessage();
                                        Toast.makeText(AddPhotos.this,"Error Occured2: " + msg, Toast.LENGTH_LONG).show();
                                        loadingBar.dismiss();
                                    }
                                }
                            });
